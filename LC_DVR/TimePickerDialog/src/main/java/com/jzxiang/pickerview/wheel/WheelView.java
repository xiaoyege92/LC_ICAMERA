...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
    ...
    public void setConfig(PickerConfig config) {
        mPaintLineCenter.setColor(getResources().getColor(R.color.timepicker_toolbar_bg));
        mPaintLineCenter.setAlpha((int) (0.1 * 500));
        mPaintRectCenter.setColor(getResources().getColor(R.color.timepicker_toolbar_bg));
        mPaintRectCenter.setAlpha((int) (0.1 * 500));
