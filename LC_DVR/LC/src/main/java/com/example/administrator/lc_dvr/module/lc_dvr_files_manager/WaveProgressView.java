...
public class WaveProgressView extends View {
     ...
     * 默认波长
     */
    private final int DEFAULT_RADIUS = dp2px(10);

    /**
     * 默认波峰和波谷的高度
     */
    private static final int DEFAULT_WAVE_HEIGHT = 2;
    ...
    private void getAttrs(AttributeSet attrs) {
        ...
        mWaveColor = ta.getColor(R.styleable.WaveProgressView_waveColor, getResources().getColor(R.color.primary_dark));
        mBorderColor = ta.getColor(R.styleable.WaveProgressView_borderColor, getResources().getColor(R.color.primary_dark));
