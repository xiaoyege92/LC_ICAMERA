 ...
 * </pre>
 */
public class ScreenListener2 {

    private Context mContext;
    private ScreenBroadcastReceiver receiver;
    private ScreenStateListener mScreenStateListener;

    public ScreenListener2(Context context) {
        mContext = context;
            ...
            if (intent != null) {
                ...
                if (Intent.ACTION_SCREEN_ON.equals(action)) {
                    if (mScreenStateListener != null) {
                        ...
                        Log.e("ScreenListener2","........onScreenOn.......");
                    }
                } else if (Intent.ACTION_SCREEN_OFF.equals(action)) {
                    if (mScreenStateListener != null) {
                        mScreenStateListener.onScreenOff();
                        Log.e("ScreenListener2","........onScreenOff.......");
                    }
                } else if (Intent.ACTION_USER_PRESENT.equals(action)) {
                    if (mScreenStateListener != null) {
                        mScreenStateListener.onUserPresent();
                        Log.e("ScreenListener2","........onUserPresent.......");
                    }
                }
            }
        }
