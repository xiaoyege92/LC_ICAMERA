...
public class OperationGuideActivity extends BaseActivity{
    ...
    protected void init() {
        //设置页面的标题
        advertisement_title.setText("操作指南");
        init2();
        if(VLCApplication.configsDictionary.get("key_helpurl") != null) {
            webView.loadUrl(VLCApplication.configsDictionary.get("key_helpurl"));
        }else {
            webView.loadUrl("http://www.bossbang.wang/v/5b972f572c93553aaf32f417");
        }
